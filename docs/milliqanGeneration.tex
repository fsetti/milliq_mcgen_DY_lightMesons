...
\begin{figure}
  ...
  \caption{\protect Cross-section times branching ratios for various
    ...
    Also: the mother particle must be in $|\eta|<1$, but the
    daughter $\zeta^{\pm}$ could have $|\eta|>1$.  On the other hand some
    $\zeta$'s with $|\eta|<1$ can arise from mothers of $|\eta|>1$.
