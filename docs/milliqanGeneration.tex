...
Technically, this is done in Madgraph by simply modifying the mass and couplings
...
We cannot find a parameter to control this, but there appears to be a $\zeta^+\zeta^-$ invariant
